...
const DomainRubric: React.FC = () => {
  ...
  const domainOptions: DomainOption[] = [
    ...
    },
    {
      ...
      notes: "Game of Life creator, but conflicts with funder name"
    },
    {
      name: "Simbase",
      domain: "simbase.io",
      ...
      notes: "Like 'database' for simulations"
    },
    {
      name: "Forrester",
      domain: "forrester.io",
    ...
    },
    {
      ...
      notes: "From 'lattice' - grid simulations"
    },
    {
      name: "Socisim",
      domain: "socisim.io",
